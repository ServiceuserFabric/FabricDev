...
# # Data Prep: genProductPostingGroups
# 
# 
# Ingest data from raw bc tables and combines them into table, table is writen into dp lakehouse with overwrite
...
target_table   = "DP.dp_genProductPostingGroups"

genProductPostingGroups_bc = FM_Utility.load_cleaned_dataframe('Raw','GenProductPostingGroup','camel')
...
genProductPostingGroups_bc = genProductPostingGroups_bc.select(
    'code',
    'description',
    'company',
...
result = genProductPostingGroups_bc.select(
